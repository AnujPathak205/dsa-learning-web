...
export default function LinkedListDisplay({ linkedlist, visualNodes }) {
  const displayVisualNodes = visualNodes.some(
    (node) => node.state === "normal"
  );
  ...
  return (
    <div className="w-full">
      ...
      {/* ================= VISUAL NODES ================= */}
      {displayVisualNodes && (
        <div className="w-full mt-10 overflow-x-auto pb-2">
          <div className="w-max mx-auto flex items-start gap-6 px-4">
